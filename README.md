...
Patches can run on a shoestring server, but the installer will check to make sure you have at least 80GBs of free space during the installation.
...
**BETA**: A bug was found in OME. It does not appear to allow ports other than 80 for HTTP. Currently OME is not able to pull from Patches since it listens on 8080. This will be fixed for the release.
